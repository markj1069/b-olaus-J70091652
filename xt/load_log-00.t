...
#---------------------------------------------------------------------------------------------------
#
# Test load_log Function Test Errors
#
#---------------------------------------------------------------------------------------------------
...
# Test 1 source
type ols_load_log >/dev/null 2>/dev/null; EX=$?  # Check that load_input is defined.
...
is $OLS_LOG $TRUE "true" "$SCRIPT_NAME: $unit_test: Check OLS_LOG is set to true."
