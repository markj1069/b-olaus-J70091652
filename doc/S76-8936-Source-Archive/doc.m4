define(`dc_title', `Software Specification Document')dnl
define(`dc_title_alternative', `Software Spec Template')dnl
define(`dc_title_short', `SRS Template')dnl
define(`dc_title_subtitle', `Source Archive')dnl
define(`dc_keyword_1', `software')dnl
define(`dc_keyword_2', `specification')dnl
define(`dc_keyword_3', `archive')dnl
...
define(`dc_description', `|
    The **archive** manages any number of member=
    >?:""
...
define(`dc_description_abstract', `Nullam commodo, nisi vel euismod porta, ex arcu blandit orci, sagittis finibus metus massa a nunc. Vestibulum tincidunt scelerisque sem a volutpat. Curabitur ipsum massa, faucibus nec lectus scelerisque, lobortis porttitor nibh.')dnl
...
define(`dc_source', `https://github.com/markj1069/templates-J70413419/tree/master/doc/X76-1589/V00')dnl
...
define(`dc_identifier', `X76-1589-00')dnl
define(`dc_identifier_bibliographicCitation', `(N/A)')dnl
define(`dc_identifier_doc', `X76-1589-00')dnl
