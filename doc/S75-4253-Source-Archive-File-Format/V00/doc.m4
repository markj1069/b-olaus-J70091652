define(`dc_title', `Source Archive File Format')dnl
define(`dc_title_alternative', `Source Archive File')dnl
define(`dc_title_short', `Source Archive File')dnl
define(`dc_title_subtitle', `Source Archive Format')dnl
define(`dc_keyword_1', `software')dnl
define(`dc_keyword_2', `source archive')dnl
define(`dc_keyword_3', `file format')dnl
define(`dc_keyword_4', `srs')dnl
...
define(`dc_description', `The Source Archive .')dnl
define(`dc_description_abstract', `(N/A)')dnl
...
define(`dc_source', `https://github.com/markj1069/templates-J70413419/tree/master/doc/S75-4253/V00')dnl
...
define(`dc_relation_references', `ar(1), archive[^1][^2]')dnl
...
define(`dc_identifier', `X76-1590-00')dnl
define(`dc_identifier_bibliographicCitation', `(N/A)')dnl
define(`dc_identifier_doc', `X76-1590-00')dnl
define(`dc_identifier_func', `Template')dnl
define(`dc_identifier_proj', `J70091652')dnl
