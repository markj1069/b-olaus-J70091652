...
What files are touched or required.

=head1 STANDARDS

What standards apply to this script.
...
What publications were used in the creation of this doc.

=head1 SEE ALSO

B<other scripts>, B<other functions>, B<other commands>
